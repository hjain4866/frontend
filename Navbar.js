...
export const Navbar = () => {
  ...
  <li className="nav-item">
    <Link className="nav-link active" aria-current="page" to='/inside'><img src={newlogo} height="40px" alt="" /></Link>
  </li>
  <li className="nav-item">
  ...
  <li className="nav-item">
    <Link className="nav-link active" aria-current="page" to='/'><img src={newlogo} height="40px" alt="" /></Link>
  </li>
  <li className="nav-item">
